function preload(){
    ...
    youwonImg=loadImage("./simpsons/youwon.png")
    muteButtonImg=loadImage("./simpsons/mute.png")
    eatingSound=loadSound("./simpsons/eating.wav")
    gameoverSound=loadSound("./simpsons/gameover.wav")
    youwonSound=loadSound("./simpsons/youwon.wav")
    bgmusic=loadSound("./simpsons/bgmusic.wav")
}
function setup(){
    ...
    wall30=createSprite(1360,170,20,125)
    ...
    title=createSprite(1150,300)
    title.addImage(titleImg)
    title.scale=1.3

    muteButton=createImg("simpsons/mute.png")
    muteButton.position(width-100,height-100)
    muteButton.size(100,80)
    ...
    alert("For best experience, set the screen size to 75% !")
